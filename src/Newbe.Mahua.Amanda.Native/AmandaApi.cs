...
namespace Newbe.Mahua.Amanda.NativeApi
{
    ...
    public class AmandaApi : IAmandaApi
    {
        ...
        /// <param name="内容"></param>
        /// <returns></returns>
        void IAmandaApi.Api_SendMsg(string 类型, string 群组, string QQ号, string 内容)
        ...
        /// <returns></returns>
        string IAmandaApi.Api_GetPointsName(int 积分类型)
        ...
        /// <param name="积分类型"></param>
        /// <returns></returns>
        int IAmandaApi.Api_GetPointsState(int 积分类型)
        ...
        /// <returns></returns>
        long IAmandaApi.Api_SetPointsNum(int 积分类型, string 群号, string QQ号, long 积分数值)
        ...
        /// <param name="积分数值"></param>
        /// <returns></returns>
        long IAmandaApi.Api_AddPoints(int 积分类型, string 群号, string QQ号, long 积分数值)
        ...
        /// <param name="积分数值"></param>
        /// <returns></returns>
        long IAmandaApi.Api_ReducePoints(int 积分类型, string 群号, string QQ号, long 积分数值)
