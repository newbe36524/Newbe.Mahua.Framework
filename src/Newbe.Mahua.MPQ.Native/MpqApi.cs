...
namespace Newbe.Mahua.MPQ.Native
{
    public class MpqApi : IMpqApi
    {
        ...
        /// <returns></returns>
        string IMpqApi.Api_GetGtk_Bkn(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetBkn32(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetLdw(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetSessionkey(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetClientkey(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetLongClientkey(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetCookies(string 响应的QQ)
        ...
        /// <param name="名片"></param>
        /// <returns></returns>
        void IMpqApi.Api_Cache_NameCard(string 群号, string QQ, string 名片)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        void IMpqApi.Api_DBan(string 响应的QQ, string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        void IMpqApi.Api_Ban(string 响应的QQ, string QQ)
        ...
        /// <returns></returns>
        bool IMpqApi.Api_Shutup(string 响应的QQ, string 群号, string QQ, int 时长)
        ...
        /// <param name="内容"></param>
        /// <returns></returns>
        void IMpqApi.Api_SetNotice(string 响应的QQ, string 群号, string 标题, string 内容)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetNotice(string 响应的QQ, string 群号)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetNameCard(string 响应的QQ, string 群号, string QQ)
        ...
        /// <param name="名片"></param>
        /// <returns></returns>
        void IMpqApi.Api_SetNameCard(string 响应的QQ, string 群号, string QQ, string 名片)
        ...
        /// <returns></returns>
        void IMpqApi.Api_QuitDG(string 响应的QQ, string 讨论组ID)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        bool IMpqApi.Api_DelFriend(string 响应的QQ, string QQ)
        ...
        /// <param name="对象"></param>
        /// <returns></returns>
        bool IMpqApi.Api_Kick(string 响应的QQ, string 群号, string 对象)
        ...
        /// <returns></returns>
        void IMpqApi.Api_JoinGroup(string 响应的QQ, string 群号, string 附加理由)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        void IMpqApi.Api_QuitGroup(string 响应的QQ, string 群号)
        ...
        /// <returns></returns>
        string IMpqApi.Api_UploadPic(string 响应的QQ, int 参_上传类型, string 参_参考对象, byte[] 参_图片数据)
        ...
        /// <returns></returns>
        string IMpqApi.Api_GuidGetPicLink(string 图片GUID)
        ...
        /// <returns></returns>
        int IMpqApi.Api_Reply(string 响应的QQ, int 信息类型, string 回复对象, string 内容)
        ...
        /// <param name="内容">信息内容</param>
        /// <returns></returns>
        int IMpqApi.Api_SendMsg(string 响应的QQ, int 信息类型, int 参考子类型, string 收信群_讨论组, string 收信对象, string 内容)
        ...
        /// <returns></returns>
        string IMpqApi.Api_Send(string 封包内容)
        ...
        /// <returns></returns>
        int IMpqApi.Api_OutPut(string 内容)
        ...
        /// <returns></returns>
        bool IMpqApi.Api_Login(string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        void IMpqApi.Api_Logout(string QQ)
        ...
        /// <returns></returns>
        string IMpqApi.Api_Tea加密(string 加密内容, string Key)
        ...
        /// <param name="Key"></param>
        /// <returns></returns>
        string IMpqApi.Api_Tea解密(string 解密内容, string Key)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetNick(string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetQQLevel(string QQ)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        string IMpqApi.Api_GNGetGid(string 群号)
        ...
        /// <returns></returns>
        string IMpqApi.Api_GidGetGN(string 群ID)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        bool IMpqApi.Api_IfBlock(string 响应的QQ)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetAdminList(string 响应的QQ, string 群号)
        ...
        /// <param name="内容"></param>
        /// <returns></returns>
        string IMpqApi.Api_AddTaotao(string 响应的QQ, string 内容)
        ...
        /// <param name="对象"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetSign(string 响应的QQ, string 对象)
        ...
        /// <param name="内容"></param>
        /// <returns></returns>
        string IMpqApi.Api_SetSign(string 响应的QQ, string 内容)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetGroupListA(string 响应的QQ)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetGroupListB(string 响应的QQ)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetGroupMemberA(string 响应的QQ, string 群号)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetGroupMemberB(string 响应的QQ, string 群号)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetFriendList(string 响应的QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        int IMpqApi.Api_GetQQAge(string 响应的QQ, string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        int IMpqApi.Api_GetAge(string 响应的QQ, string QQ)
        ...
        /// <returns></returns>
        string IMpqApi.Api_GetPersonalProfile(string 响应的QQ, string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetEmail(string 响应的QQ, string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        int IMpqApi.Api_GetGender(string 响应的QQ, string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        int IMpqApi.Api_SendTyping(string 响应的QQ, string QQ)
        ...
        /// <param name="QQ"></param>
        /// <returns></returns>
        int IMpqApi.Api_SendShake(string 响应的QQ, string QQ)
        ...
        /// <returns></returns>
        bool IMpqApi.Api_AddQQ(string QQ, string 密码, bool 自动登录)
        ...
        /// <returns></returns>
        bool IMpqApi.Api_SetOLStatus(string 响应的QQ, int 在线状态, string 状态附加信息)
        ...
        /// <param name="群号"></param>
        /// <returns></returns>
        string IMpqApi.Api_GroupInvitation(string 响应的QQ, string 好友QQ, string 群号)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_CreateDG(string 响应的QQ)
        ...
        /// <param name="成员"></param>
        /// <returns></returns>
        string IMpqApi.Api_KickDG(string 响应的QQ, string 讨论组ID, string 成员)
        ...
        /// <returns></returns>
        string IMpqApi.Api_DGInvitation(string 响应的QQ, string 讨论组ID, string 成员组)
        ...
        /// <param name="响应的QQ"></param>
        /// <returns></returns>
        string IMpqApi.Api_GetDGList(string 响应的QQ)
        ...
        /// <returns></returns>
        bool IMpqApi.Api_SendMusic(string 响应的QQ, int 收信对象类型, string 收信对象所属群_讨论组, string 收信对象QQ, string 音乐简介,
        ...
        /// <returns></returns>
        bool IMpqApi.Api_SendObjectMsg(string 响应的QQ, int 收信对象类型, string 收信对象所属群_讨论组, string 收信对象QQ, string ObjectMsg,
            int 结构子类型)
        ...
        /// <returns></returns>
        bool IMpqApi.Api_IsFriend(string 响应的QQ, string 对象QQ)
